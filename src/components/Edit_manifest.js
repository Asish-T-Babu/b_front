...
function Edit_manifest() {
  let{manifest,addRowManifest,setAddManifestDisplay,editManifest,editManifestBoolean,setEditManifestBoolean}=useContext(PostContext)
  let id  = useParams();
  ...
  console.log(editManifestBoolean);
//   useEffect(() => {
//       setWeek(editManifest.week)
//       setUStatus(editManifest.status)
//       setNextWeekTask(editManifest.next_week_task)
//       setReviewerName(editManifest.reviewer_name)
//       setAdvisorName(editManifest.advisor_name)
//       setProjectUpdation(editManifest.project_updation)
//       setTechinicalScore(editManifest.techinical_score)
//       setExtraWorkoutsReview(editManifest.extra_workouts_review)
//       setExtraWorkoutsScore(editManifest.extraWorkoutsScore)
//       setEnglishReview(editManifest.english_review)
//       setEnglishScore(editManifest.english_score)
// },[]);
console.log("123",editManifest)
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                defaultValue={editManifest.week} onChange={(e)=>setWeek(e.target.value)}
              />
            ...
            <InputLabel id="demo-simple-select-label">Status</InputLabel>
              <Select
                ...
                name="status"
                autoComplete="status"
                defaultValue={editManifest.week} onChange={handleChange}
              >
            ...
            <Grid item xs={12}>
              <TextField
                ...
                defaultValue={editManifest.project_updation} onChange={(e)=>setProjectUpdation(e.target.value)}
              />
            </Grid>
            ...
            <Grid item xs={12} xl={40}>
              <TextField
                ...
                type="Next Week Task"
                id="next_week_task"
                defaultValue={editManifest.next_week_task} onChange={(e)=>setNextWeekTask(e.target.value)}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                id="reviewer_name"
                label="Reviewer name"
                defaultValue={editManifest.reviewer_name} onChange={(e)=>setReviewerName(e.target.value)}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                id="advisor_name"
                label="Advisor Name"
                defaultValue={editManifest.advisor_name} onChange={(e)=>setAdvisorName(e.target.value)}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
