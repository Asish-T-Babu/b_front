...
import OurProfileData from './OurProfileData'
  ...
  return (
    ...
    <div className="flex flex-col border-r border-neutral-700 w-100 h-screen">
      ...
      <div className="flex justify-between items-center bg-[#202d33] h-[60px] p-3">
        ...
        {/* Profile nav buttons */}
        <div className="flex justify-between w-[40px]">
        <button onClick={()=>{navigate('/group_chat')}}>
          <RoundedBtn icon={<MdPeopleAlt />} /></button>
